#!/bin/bash
# 🚀 Complete RunPod Setup Script for VAP Phase 3 Training
# This script handles everything from environment setup to training start
# Run this ONCE after connecting to your RunPod instance

set -e  # Exit on any error

echo "🚀 VAP Phase 3 - Complete RunPod Setup"
echo "======================================"
...
install_python_deps() {
    ...
    log_info "Installing PyTorch 2.1.1 with CUDA 12.1..."
    pip install torch==2.1.1 torchvision==0.16.1 torchaudio==2.1.1 --index-url https://download.pytorch.org/whl/cu121
    
    # Install other ML dependencies
    log_info "Installing ML framework dependencies..."
    pip install pytorch-lightning==2.5.3 tensorboard tqdm pyyaml numpy requests
    ...
    pip install lhotse torch-audiomentations pyannote.audio
    
    # Install utility libraries
    log_info "Installing utility libraries..."
    pip install matplotlib scipy hydra-core wandb
...
setup_repository() {
    log_info "Setting up VAP repository..."
...
# Install VAP package
install_vap_package() {
    log_info "Installing VAP package..."
    
    cd "$PROJECT_DIR"
    pip install -e .
    
    log_success "VAP package installed"
}
...
setup_dataset() {
    log_info "Setting up LibriSpeech dataset..."
...
# Main execution
main() {
    echo "Starting complete RunPod setup..."
    echo ""
